    ...
    <nav className="hidden xl:flex flex-col w-[15%] h-full border-r-1 border-secondary py-3">
      <div className="px-4 flex items-center gap-x-2">
        ...
        <h5 className="text-2xl ">
          Wise<span className="text-primary text-xl">Wallet.</span>
        </h5>
      </div>
      <menu className="w-full h-full flex flex-col px-3 mt-12">
        <div className="space-y-6 flex flex-col">
          ...
          <li
            className={`link ${
              isRouteActive("/dashboard/assistant") ? "activeLink" : ""
            }`}
            onClick={() => {
          ...
          <li
            className={`link ${
              isRouteActive("/dashboard/education") ? "activeLink" : ""
            }`}
            onClick={() => {
              navigate("/dashboard/education");
            }}
          >
            <Education className="size-[1.5rem]" />
            Education
          </li>
          <li
            className={`link ${
              isRouteActive("/dashboard/scholarship") ? "activeLink" : ""
            }`}
            onClick={() => {
